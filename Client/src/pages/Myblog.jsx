        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {list.map((value) => (
            ...
            >
              ...
              :
              null}
                <button className="bg-[#EE7214] text-white py-2 px-4 rounded hover:bg-[#d65a2b] transition duration-300" onClick={()=>DeleteBlog(value._id)}>
                  Delete
                </button>
                <button className="bg-[#527853] text-white py-2 px-4 rounded hover:bg-[#4a6a4b] transition duration-300" onClick={()=>{UpdateBlog(value._id); setButtonn(true)}}>
                  Update
                </button>
              </div>
            </div>
